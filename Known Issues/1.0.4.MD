...
- Fix: In BlockHitCheck, playerShotItem needs to be set to False upon exploding in the Trident section. This prevents an additional explosion.
...
- Fix: Create MobShot flag in LaunchCheck and check the mobshot check in BlockHit and EntityHit.
...
- Fix: Instead of deleting the arrow, just set playerShotItem to False.
